(defproject ti4_web_frontend "0.1.0-SNAPSHOT"
  ...
  :ring {:handler ti4-web-frontend.handler/app
         :uberwar-name "ti4_web_frontend.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "ti4_web_frontend.jar"
  :main ti4-web-frontend.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "ti4-web-frontend.core/mount-root"}
             :compiler
             {:main "ti4_web_frontend.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns ti4-web-frontend.repl}
